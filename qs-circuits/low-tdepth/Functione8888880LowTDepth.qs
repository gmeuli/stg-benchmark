...
operation Functione8888880LowTDepth (controls : Qubit[], target : Qubit) : Unit
{
        ...
        using (anc = Qubit[6]) {
            ...
            ApplyToEachA(CNOT(_, anc[0]), [controls[1], controls[0], controls[4]]);
            ApplyLowDepthAnd(anc[3], anc[0], anc[1]);
            Adjoint ApplyToEachA(CNOT(_, anc[0]), [controls[1], controls[0], controls[4]]);
            ApplyToEachA(CNOT(_, anc[0]), [anc[3], anc[4]]);
            ApplyToEachA(CNOT(_, anc[2]), [anc[1], anc[3]]);
            ApplyLowDepthAnd(anc[0], anc[2], anc[5]);
            Adjoint ApplyToEachA(CNOT(_, anc[2]), [anc[1], anc[3]]);
            Adjoint ApplyToEachA(CNOT(_, anc[0]), [anc[3], anc[4]]);
            CNOT(anc[4], anc[5]);
            ...
            Adjoint ApplyToEachA(CNOT(_, anc[0]), [anc[3], anc[4]]);
            ApplyToEachA(CNOT(_, anc[0]), [controls[1], controls[0], controls[4]]);
            Adjoint ApplyLowDepthAnd(anc[3], anc[0], anc[1]);
            Adjoint ApplyToEachA(CNOT(_, anc[0]), [controls[1], controls[0], controls[4]]);
            ApplyToEachA(CNOT(_, anc[0]), [controls[3], controls[2]]);
            ApplyToEachA(CNOT(_, anc[1]), [controls[2], controls[1], controls[0]]);
            ApplyToEachA(CNOT(_, anc[2]), [controls[1], controls[0]]);
